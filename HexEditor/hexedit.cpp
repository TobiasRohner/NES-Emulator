...
HexEdit::HexEdit(std::vector<char> *data, QWidget *parent) : QAbstractScrollArea(parent),ui(new Ui::HexEdit)
{
    ui->setupUi(this);
...
inline QString HexEdit::hex(char value) {
...
void HexEdit::writeNibble(unsigned char value) {
